...
import com.example.pang.spacedeliveryfordeliverman.deliverman.DeliLogin;
import com.example.pang.spacedeliveryfordeliverman.deliverman.DeliRegister;
...
public class MainActivity extends FragmentActivity {
    ...
    private class MyPageAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new DeliLogin();
                case 1:
                    return new DeliRegister();
                default:
                    return null;
            }
        }
