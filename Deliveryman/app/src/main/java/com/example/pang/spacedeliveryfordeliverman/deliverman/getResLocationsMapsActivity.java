...
public class getResLocationsMapsActivity extends FragmentActivity implements OnMapReadyCallback,DirectionCallback {
    ...
    public void deliInfo(){
        Intent goToUpdate = new Intent(getResLocationsMapsActivity.this, deliInfo.class);
    ...
    public  void submitDeliver(){
        ...
        Ion.with(getApplication())
                .load(baseUrl+"submitDeliman.php")
                .setMultipartParameter("deli_id", String.valueOf(deli_id))
                .setMultipartParameter("deliman_id", String.valueOf(user_id))
                .asJsonObject()
    ...
    public void getAddress(double lat, double lng) {
        Geocoder geocoder = new Geocoder(getResLocationsMapsActivity.this, Locale.getDefault());
        try {
            ...
            send_point.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new AlertDialog.Builder(getResLocationsMapsActivity.this)
                            .setTitle("จุดส่ง")
